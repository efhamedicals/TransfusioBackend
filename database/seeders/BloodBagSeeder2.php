...
class BloodBagSeeder2 extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        if (empty($bloodCenterIds)) {
            $this->command->warn('[BloodBagSeeder2] Aucun centre de transfusion trouvé. Abandon du seeder.');
            return;
        }
        ...
        $this->command->info('[BloodBagSeeder2] 120 poches de sang insérées avec succès.');
